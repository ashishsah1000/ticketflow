...
2. "lookup_complaint" - The user wants to check the status, details, history, or actions performed on a complaint/ticket. Extract the complaint_id if provided (e.g., from "CMP12345" extract "CMP12345").
